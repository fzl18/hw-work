...
const issuer0 = {
  address: 'bKySVnf6vxDtNeQAZUgpWWBdoMBcnyQmoq',
...
const issuer1 = {
  address: 'bpmFKmAcYskZdmtmcTwwFAuVcsRYsQgBXA',
  secret: 'sa3reopGdU4UkCqVEuR62vwVBad3x'
}

const account0 = {
  address: 'bGiohV7XVhabbtV1DfKjWEyikeyimiDSNx',
  secret: 'ssaWWHNnYyU4R8WdSzD8XFCNxKyYc'
}

const account1 = {
  address: 'bPKbrbSLKRmgb5nqqGP3hxWBj6o2ufZrTt',
...
const base = {
  ...
  counter = {
    currency: 'CNY',
    issuer: 'bUPd52jHtu1d88nc3S3WeroACFQpKfybhU'
}

const orderAddress = 'bM5F6qeCQBxSQQeoKdCPURq4sNFgZeFD5Y'
