...
const BinarySerializer = makeClass({
  BinarySerializer: function (sink) {
    this.sink = sink;
  },
  ...
  writeBytesList: function (bl) {
    bl.toBytesSink(this.sink);
  },
  encodeVL: function (len) {
    let length = len;
  ...
  writeFieldAndValue: function (field, _value) {
  ...
  writeLengthEncoded: function (value) {
