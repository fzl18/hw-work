    ...
    <section>
        ...
        <list class="coinRecord" :url="api.transLog" >
            ...
            <dl slot="body" slot-scope="{item}" >
                ...
                <dd style="width:30%">{{item.type == 1 ? lang[local].takeCoin:item.type == 2 ? lang[local].myDeal_ServiceCharge:item.type == 3 ? lang[local].pushCoin:item.type == 4 ? lang[local].otcTrade : item.type == 5 ?lang[local].icoTrade : item.type == 6 ? lang[local].icoFree1: item.type == 7 ?lang[local].icoFree2 : item.type == 8 ? lang[local].icoFree3 :item.type == 9 ?lang[local].icoFree4:item.type == 10 ?lang[local].icoFree5:item.type == 11 ? lang[local].icoFree6 : 'OTC'}}</dd>
