...
var compileSchema = require('./compile/index.js'),
    resolve = require('./compile/resolve.js'),
    Cache = require('./cache.js'),
    SchemaObject = require('./compile/schema_obj.js'),
    stableStringify = require('../../fast-json-stable-stringify/index.js'),
    formats = require('./compile/formats.js'),
    rules = require('./compile/rules.js'),
    $dataMetaSchema = require('./$data.js'),
    patternGroups = require('./patternGroups.js'),
    util = require('./compile/util.js'),
    co = require('../../co/index.js');
...
Ajv.prototype.compileAsync = require('./compile/async.js');
var customKeyword = require('./keyword.js');
Ajv.prototype.addKeyword = customKeyword.add;
Ajv.prototype.getKeyword = customKeyword.get;
Ajv.prototype.removeKeyword = customKeyword.remove;

var errorClasses = require('./compile/error_classes.js');
...
function addDraft6MetaSchema(self) {
  var $dataSchema;
  if (self._opts.$data) {
    $dataSchema = require('./refs/$data.json.js');
    self.addMetaSchema($dataSchema, $dataSchema.$id, true);
  }
  if (self._opts.meta === false) return;
  var metaSchema = require('./refs/json-schema-draft-06.json.js');
