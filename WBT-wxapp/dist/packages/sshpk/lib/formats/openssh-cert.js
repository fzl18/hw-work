...
var SSHBuffer = require('../ssh-buffer.js');
...
var rfc4253 = require('./rfc4253.js');
...
function toBuffer(cert, noSig) {
	...
	if (sig.critical === undefined) sig.critical = Buffer.alloc(0);
	buf.writeBuffer(sig.critical);

	if (sig.exts === undefined) sig.exts = Buffer.alloc(0);
